	...
	return (
		<>
			...
			<div className="flex flex-col items-center py-10 w-[304px]">
				...
				<button
					className="px-6 py-2 text-sm leading-6 transition-colors border-transparent rounded-md bg-zinc-800 hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-300 disabled:opacity-50 disabled:hover:bg-brand-500"
